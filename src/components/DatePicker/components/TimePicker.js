...
// Styles
import { TimePickerStyle, InputContentStyle, IconErrorStyle, HelptexttStyle, ErrorIcon } from '../styles';

// Componentes
import { Icon } from '~/components';

function TimePicker({ value, onChange, allowClear, disabled, disabledDate, helpText, error = false }) {
